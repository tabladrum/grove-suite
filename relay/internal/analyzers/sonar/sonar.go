...
// `relay tools install --with-sonar`; see internal/tools/registry.go.
...
type Analyzer struct {
	// ProfilePath is the absolute or .relay/-relative path to the
...
// installed. Both come from `relay tools install --with-sonar`.
...
//  2. Bundled JRE installed by `relay tools install --with-sonar`
