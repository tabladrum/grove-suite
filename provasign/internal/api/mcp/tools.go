...
func toolDescriptors() []map[string]any {
	return []map[string]any{
		...
		// ── Auto-Intent Capture ─────────────────────────────────────────
		{
			"name": "provasign_intent_open",
			"description": "Draft an Intent from the user's prompt BEFORE making code changes. " +
				"Stores a draft YAML at .provasign/.cache/intents/INT-{id}.draft.yaml. " +
		...
		{
			"name": "provasign_intent_close",
			"description": "Promote the intent draft to .provasign/intents/{id}.yaml (committed). " +
