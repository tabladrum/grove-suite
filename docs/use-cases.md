...
- **[Change management]({{ '/use-cases/change-management/' | relative_url }})** — every admission is gated, signed, and linked to an approved intent.
- **[Traceability]({{ '/use-cases/traceability/' | relative_url }})** — an unbroken chain from natural-language prompt to admitted commit.

Each maps to specific controls in SOC 2, and to the traceability artifact the EU AI Act expects for high-risk activities.
