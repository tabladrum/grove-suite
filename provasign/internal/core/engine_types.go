...
type Certificate struct {
	...
	EffectiveConfigHash string // sha256 of canonical .provasign/ snapshot
...
// RelayConfig is the in-memory representation of merged .provasign/ configuration.
...
type RelayConfig struct {
	ProvasignVersion string                    `json:"provasign_version"`
