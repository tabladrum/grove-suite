...
// AnalyzerConfig is the per-analyzer block in `.provasign/provasign.yaml`. The map
...
type AnalyzerConfig struct {
	...
	// the active quality-profile XML path (relative to .provasign/).
	...
	// .provasign/rulesets/ that the analyzer can natively consume in addition
